...
#define FILTER_FRIENDLY_NAME        L"iDevPeek NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{a79dd781-f2a8-43cc-a1dc-1794a1034263}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"iDevPeek"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\iDevPeek"
#define NTDEVICE_STRING             L"\\Device\\iDevPeek"
...
DRIVER_DISPATCH iDevPeekDispatch;

DRIVER_DISPATCH iDevPeekDeviceIoControl;
