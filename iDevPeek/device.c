...
/*
En proyectos NDIS o controladores en general, se incluyen muchas cabeceras del sistema (ntddk.h, ndis.h, etc.), que pueden ser pesadas y aumentar el tiempo de compilación.
...
PACKET_DATA CapturedPacket;  // Buffer para almacenar el último paquete capturado
FILTER_RULE CurrentFilter;   // Configuración actual del filtro
    ...
    )
{
    ...
    Status = NdisRegisterDeviceEx(
                ...
                &DeviceAttribute,
                &NdisDeviceObject,
                &NdisFilterDeviceHandle // manejador del dispositivo NDIS para comunicación con user-mode. En filter.c
                );
    ...
    )
{
    ...
    switch (IrpSp->Parameters.DeviceIoControl.IoControlCode)
    {
        ...
        case IOCTL_IDEVPEEK_GET_PACKET:
        {
            ...
            // Aquí deberíamos copiar un paquete capturado en el buffer de salida
        ...
        case IOCTL_IDEVPEEK_SET_FILTER:
        {
            ...
            // Aquí procesaríamos un filtro enviado por la app
